...
class VerticalProgressVIew: UIView {
    ...
    func commonInit() {
        ...
        progresView.progressTintColor = UIColor.lightBlue.color//UIColor(red: 1.0, green: 0.21, blue: 0.33, alpha: 1)
...
//        progresView.transform = CGAffineTransform(rotationAngle: .pi)
        ...
        let modofierH: CGFloat = self.bounds.width > self.bounds.height ? 4 : self.contentView.bounds.height
